...
def newEvent():
    ...
    try:
        with extensionCur as cursor:
            ...
            sql = "INSERT INTO events (name,description,company,userid,eventid,starttimestamp,endtimestamp,endtime,starttime,latitude,longitude,address,location) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
